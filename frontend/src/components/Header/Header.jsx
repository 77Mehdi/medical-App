      ...
      <div className="container">
        <div className="flex items-center justify-between">
          <div className=' flex cursor-pointer'>
            <img src={logo} alt="" className=' rounded-[50px] h-24 w-24 hidden sm:block ' /><span className='mt-7 sm:mt-5 font-bold text-3xl'>Med<span className=' text-red-400'>icare</span></span>
          </div>
